...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-31ggt$$@=8kjmq^3r#3vmr#+=t@-^#g#q@z8hd&e1-qlghzsm1')
...
# CSRF Settings
CSRF_TRUSTED_ORIGINS = ['http://localhost:3000', 'http://127.0.0.1:3000', 'http://localhost:8000', 'http://127.0.0.1:8000', 'https://muchatrodol.vercel.app']
